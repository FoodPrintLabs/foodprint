...
router.get(
  ...
  function (req, res) {
    ...
    models.FoodprintWeeklyview.findAll(weeklyViewQuery)
      ...
      .finally(() => {
        var boolTracedOnBlockchain =
          process.env.SHOW_TRACED_ON_BLOCKCHAIN || false;
...
router.post(
  "/marketcheckin",
  [
    check("checkin_email", "Your email is not valid")
      .not()
      .isEmpty()
      .isEmail()
      .normalizeEmail(),
...
router.post(
  ...
  [
    ...
    check("subscribe_email", "Your email is not valid")
      .not()
      .isEmpty()
      .isEmail()
      .normalizeEmail(),
...
router.post(
  "/contactform",
  [
    check("contact_email", "Contact email is not valid")
      .not()
      .isEmpty()
      .isEmail()
      .normalizeEmail(),
    check("contact_message", "Contact message should not be empty")
      .not()
      .isEmpty(),
    check("contact_fname", "Contact first name should not be empty")
      .not()
      .isEmpty(),
    check("contact_lname", "Contact last name should not be empty")
      .not()
      .isEmpty(),
  ],
  function (req, res) {
