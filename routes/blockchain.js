...
router.get('/app/test/blockchain/algod',
...
router.post('/app/harvest/save/blockchain',
    async function (req, res) {
        ...
        (async() => {
            ...
            res.status(201).send({ success: true, message: "Harvest entry added to Algorand blockchain",
                harvestLogid: req.body.logID, transactionId: sendTx.txId});
        })().catch( e => {
            console.log(e)
            //throw err;
